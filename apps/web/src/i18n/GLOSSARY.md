...
| Money a customer pays, as the alpha promises there is none (workplan 0131 T3) | charged | **in rekening gebracht** | *Nothing is charged* / *Er wordt niets in rekening gebracht*: the alpha note, the Billing line and the request hint. Not *invoiced* / *gefactureerd*, which is what a tier says (0109 T8, *"Free: nothing is invoiced on this tier"*): a tier's word is about the invoice, and the alpha's covers every tier, the paid ones too. As a noun on its own, *bill* / *rekening* appears only in *"it is not a bill"* / *"het is geen rekening"*. |
