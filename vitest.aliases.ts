...
export const aliases = {
  ...
  '@openmig/core/cutover-lifecycle': resolve(rootDir, 'packages/core/src/cutover-lifecycle.ts'),
  ...
  '@openmig/connectors/carddav-source.types': resolve(rootDir, 'packages/connectors/src/carddav-source.types.ts'),
  '@openmig/connectors/webdav-source': resolve(rootDir, 'packages/connectors/src/webdav-source.ts'),
  '@openmig/connectors/webdav-source.types': resolve(rootDir, 'packages/connectors/src/webdav-source.types.ts'),
  '@openmig/connectors/graph-calendar-source': resolve(rootDir, 'packages/connectors/src/graph-calendar-source.ts'),
  '@openmig/connectors/graph-calendar-source.types': resolve(rootDir, 'packages/connectors/src/graph-calendar-source.types.ts'),
  '@openmig/connectors/graph-contacts-source': resolve(rootDir, 'packages/connectors/src/graph-contacts-source.ts'),
  '@openmig/connectors/graph-contacts-source.types': resolve(rootDir, 'packages/connectors/src/graph-contacts-source.types.ts'),
  '@openmig/engines/caldav-target-writer': resolve(rootDir, 'packages/engines/src/caldav-target-writer.ts'),
  '@openmig/engines/carddav-target-writer': resolve(rootDir, 'packages/engines/src/carddav-target-writer.ts'),
  '@openmig/engines/webdav-target-writer': resolve(rootDir, 'packages/engines/src/webdav-target-writer.ts'),
