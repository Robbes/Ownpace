...
| [0033](./0033-domain-wide-delegation.md) | Whole-tenant Google migration — domain-wide delegation, opt-in and stated | **Proposed 2026-08-16** — ADR-0006's Google twin: per-user tokens stay the default; DWD as an opt-in second credential mode (dedicated service account, minimal scopes, revoke at cutover), a mapping still names one subject, refusals name the Admin-console authorisation |
