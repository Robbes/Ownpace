...
## Decision
Adopt the schema in `packages/ledger/migrations/0001_init.sql` *(update
2026-08-02: that file was squashed into `0001_baseline.sql` — generated by
`scripts/squash-migrations.sh` — which is where the schema below now lives)*:
