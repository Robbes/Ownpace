...
147 plans. Task rows by the marker their Status cell starts with: ✅ 584 · 🟢 10 · 🟡 30 · 📋 145 · ⏳ 40 · ⬜ 9 · 🔨 19 · 🚧 1 · ⛔ 12 · ⚠️ 11 · ⏸️ 5 · 🅿️ 4 · 🕓 1 · 📝 1 · 🔎 1 · unmarked 7.
...
| [0140](./0140-consent-screens-a-tester-can-pass.md) | Consent screens a tester can pass | Provider consent for testers on `ownpace-live`: its own Google OAuth client, test users, Testing or Production, a Microsoft registration ADR and publisher verification, read-only Dropbox scope, Box and Apple as experimental, the sign-in buttons. | 2026-09-26 | 12 | 📋 5 · ⏳ 4 · 🔨 3 |  |
