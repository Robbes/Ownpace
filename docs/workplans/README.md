...
| [0021](./0021-documentation-truth-pass.md) | The documentation truth pass | 🟡 **T1–T4 merged (#228–#231); T5 five of six decided AND executed** (Atlas → the `migration-lint` CI job #232; Graph-mail → workplan 0023, closed; provisioner → ADR-0008 retracted + stub deleted #238; bilingual UI → workplan 0024, closed; backup extra-copy bullet → ADR-0015 retracted #240); T6's mechanical half merged (#236). **Open: two owner answers** — the worker `--config` CLI's fate and the SECURITY.md contact — then T5 6/6 and T6 close. |
