...
4. **The UX review's plans (0033–0039)** — grown from four to seven on
   ...
   swept the surfaces the hand review had skimmed. Order: **0033 first**
   (correctness wearing UX clothes; 0037 T1's wizard unblock and 0039 T1's
   billing role guards are the other two candidates for "before anything
   else" — a hard-blocked first-run journey and unguarded money writes).
   Then 0034 (unblocks 0036 T3 and 0033 T5's selfhost half), 0035 (after
   0033 T1; carries the fold-the-debt owner question), 0036–0039 as bandwidth
   allows. Cross-plan sequencing is recorded inside each plan.
