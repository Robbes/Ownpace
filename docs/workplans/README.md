...
4. **The UX review's plans (0033–0039)** — grown from four to seven on
   ...
   **0034 landed the same day too (all five tasks)** — the hub is clickable
   ...
   redirect. Remaining order: 0039 T1's billing role guards early (unguarded
   money writes), 0035 (its 0033-T1 and nav dependencies now satisfied;
   carries the fold-the-debt owner question), then 0036/0037/0038/0039 as
   bandwidth allows. Cross-plan sequencing is recorded inside each plan.
