...
| [0148](./0148-a-guide-written-for-the-person-using-it.md) | A guide written for the person using it | Dutch and English customer guides per source and target card, operator text kept in `docs/*-setup.md`, wizard and checklist without own-app hints where the deployment carries one, export archive card hidden on managed, `Docs.tsx` renderer extended. | 2026-09-24 | 9 | 📋 7 · ⏳ 1 · 🔨 1 |  |
