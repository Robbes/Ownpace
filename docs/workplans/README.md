...
4. **The UX review's plans (0033–0039)** — grown from four to seven on
   ...
   Remaining order: 0034 next (unblocks 0036 T3 and makes 0033 T5's selfhost
   strip reachable), 0039 T1's billing role guards early (unguarded money
   writes), 0035 (after-0033-T1 dependency now satisfied; carries the
   fold-the-debt owner question), then 0036/0037/0038/0039 as bandwidth
