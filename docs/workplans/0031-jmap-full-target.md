...
**T2.1 onwards is not written until T2.0 answers**, for the same reason T0
came before T1: the two routes produce different connectors, and picking wrong
costs the connector rather than the spike.
