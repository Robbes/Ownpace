...
each their own format, laid over the single one, on both editions. The chooser on the screens
still offers one format for all four; it is next. Checking the holes found one that affects the
