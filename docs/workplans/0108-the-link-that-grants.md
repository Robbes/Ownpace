...
T8 (b), (c) and (d), and whether the page also shows the issuing owner's address. T8 (a)
recommends it; T4 deliberately left it out, so it waits on a yes rather than being assumed.
