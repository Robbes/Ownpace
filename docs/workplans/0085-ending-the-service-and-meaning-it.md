...
**Partly built (2026-08-18, continued 2026-08-19).** T1, T2, T3, T4a, T4b, T5,
T6 and T7 are done; **T8 (half) and T9 are still open**. Owner decisions recorded below, including the backup
