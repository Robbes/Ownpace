...
> **Done.** T1/T2/T3/T5/T6 done and tested. **Owner decision 2026-07-16: verify-only DNS** — T4
> (automated provider writes) stays deferred; verify-only is the permanent cutover DNS story.
